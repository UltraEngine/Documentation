...
- bool **Save**(table& properties, shared_ptr<[Stream](Stream.md)> binstream, shared_ptr<[Scene](Scene.md)> scene, const LoadFlags flags, shared_ptr<[Object](Object.md)> extra)
