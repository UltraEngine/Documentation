...
C++ provides the fastest performance and most advanced feature set for advanced programmers. Our use of smart pointers greatly improves the usability of this language. To get started, install [Visual Studio 2019](https://visualstudio.microsoft.com/vs/).
