...
| ----- | ----- | ----- |
| path | [string](https://www.lua.org/manual/5.4/manual.html#6.4) | read-only file name or URL |
| package | [string](https://www.lua.org/manual/5.4/manual.html#6.4) | read-only file name or URL |
