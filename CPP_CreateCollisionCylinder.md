...
## Syntax ##
- shared_ptr<[Collision](CPP_Collision.md)> **CreateCollisionCylinder**(const float radius, const float height, const float depth, const float x = 0.0f, const float y = 0.0f, const float z = 0.0f, const float pitch = 0.0f, const float yaw = 0.0f, const float roll = 0.0f)
- shared_ptr<[Collision](CPP_Collision.md)> **CreateCollisionCylinder**(const float radius, const float height, const [Vec3](CPP_Vec3.md)& offset = 0.0f, const [Vec3](CPP_Vec3.md)& rotation = 0.0f)
