...
| Event | Constructor | Event(EventId id, shared_ptr<[Object](Object.md)\> source, int data=0, [iVec2](iVec2.md) position = 0, [iVec2](iVec2.md) size = 0, shared_ptr<[Object](Object.md)\> extra = NULL, [WString](WString.md) text = L"") |
