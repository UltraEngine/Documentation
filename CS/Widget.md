...
|---|---|---|
| blocks | const List<[WidgetBlock](WidgetBlock.md)\> | read-only container of widget blocks |
| items | const List<[WidgetItem](WidgetItem.md)\> | read-only items list |
| kids | const List<[Widget](Widget.md)\> | read-only container of child widgets |
