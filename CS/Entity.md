...
| kids | const List<[Entity](Entity.md)> | read-only array of child entities |
| matrix | [Matrix4x4](https://docs.microsoft.com/en-us/dotnet/api/system.numerics.matrix4x4?view=net-5.0) | read-only 4x4 matrix |
| name | string | entity name |
| omega | [Vector3](https://docs.microsoft.com/en-us/dotnet/api/system.numerics.vector3?view=net-5.0) | read-only angular velocity |
| parent | [Entity](Entity.md) | entity parent |
| position | [Vector3](https://docs.microsoft.com/en-us/dotnet/api/system.numerics.vector3?view=net-5.0) | read-only position |
| properties | [Dictionary](https://docs.microsoft.com/en-us/dotnet/api/system.collections.generic.dictionary-2?view=net-5.0) | user-defined properties |
| quaternion | [Quaternion](https://docs.microsoft.com/en-us/dotnet/api/system.numerics.quaternion?view=net-5.0) | read-only rotation |
| rotation | [Vector3](https://docs.microsoft.com/en-us/dotnet/api/system.numerics.vector3?view=net-5.0) | read-only Euler rotation |
| scale | [Vector3](https://docs.microsoft.com/en-us/dotnet/api/system.numerics.vector3?view=net-5.0) | read-only scale |
| tags | const HashSet<string> | read-only container of tags |
| velocity | [Vector3](https://docs.microsoft.com/en-us/dotnet/api/system.numerics.vector3?view=net-5.0) | read-only linear velocity |
...
| [SetAngularVelocity](Entity_SetAngularVelocity.md) | Method |sets the entity angular velocity |
