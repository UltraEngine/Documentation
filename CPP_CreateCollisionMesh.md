...
## Syntax ##
- shared_ptr<[Collision](CPP_Collision.md)\> **CreateCollisionMesh**(shared_ptr<Mesh\> geometry)
- shared_ptr<[Collision](CPP_Collision.md)\> **CreateCollisionMesh**(shared_ptr<Model\> geometry)
